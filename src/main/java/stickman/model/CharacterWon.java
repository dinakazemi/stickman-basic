...
/** The state that the character has when he has completed the level */
public class CharacterWon implements CharacterState {
  ...
  /**
   * updates the screen according to the state - prints out the message "Congrats! you have finished
   * this level."
   *
   * @param character The characterImpl in the game that the screen must be updated according to them
   */
  @Override
