...
/** Creates the graphic implementation of the entities that are dynamic (followed by the camera) */
import javafx.scene.Node;
import javafx.scene.image.Image;
import javafx.scene.image.ImageView;
import stickman.model.Entity;

public class EntityViewDynamicImpl implements EntityView {
  private Entity entity;
  private boolean delete = false;
  private ImageView node;
  private String imagePath;

  EntityViewDynamicImpl(Entity entity) {
    this.entity = entity;
  ...
  /**
   * Called from game window to update the view of the entity at every moment. With dynamic
   * entities, since they are followed by the camera, update makes sure that at every moment, they
   * are within the game window bounds and changes their image path if needed.
   *
   * @param xViewportOffset The amount needed to update the position of the node - according to how
   *     much the entity has gone out of bounds
   */
  @Override
